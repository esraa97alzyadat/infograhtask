...
<!-- about page  -->
<div style=" display: block; margin-left: 50px;margin-right: 50px; padding: 30px; font-weight: bold;background-color:#C5F1CD; ">
  
    <center>
        <h1 style="size: 300px; font-weight: bold;">About</h1></br></br>  
